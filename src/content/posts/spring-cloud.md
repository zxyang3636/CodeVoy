...
```java title="AuthGlobalFilter.java"
@Component
@RequiredArgsConstructor
@Slf4j
...
```java title="AuthProperties.java"
@Data
@Component
...
```java title="UserInfoInterceptor.java"
...
```yaml title="shared-swagger.yaml"
knife4j:
  enable: true
  openapi:
...
```java title="ItemClientFallbackFactory.java"
@Slf4j
...
**注册为bean**
```java title="DefaultFeignConfig.java" {20-23}
public class DefaultFeignConfig {
    @Bean
    public Logger.Level feignLogLevel() {
        return Logger.Level.FULL;
